...
#
import os, sys, string, time, glob, gzip
basedir = "/home/noel/paquetes/popcon/popcon-canaima/popularidad-canaima/servidor"
mirrorbase = os.path.join(basedir, '/mirrors/debian')
stable_version = "1.61"
