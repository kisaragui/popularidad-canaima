...
my $email='njesusas@gmail.com';

my $directsave = 1; # Enable to store on disk instead of sending an email
my $basedir   = "/home/noel/paquetes/popcon/popcon-canaima/popularidad-canaima/servidor";
